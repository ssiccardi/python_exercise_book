...
#    s2 = st.tag(s1)     # stanford tagger
    ...
    exceptions = ["%",",","painting","quality","household","canvas","art","nude","beige","sexy","34-46","fashion","round","sports","classic","men","mixed","toe","dog","nest"]
    exc_tags = [":",":","NN","JJ","JJ","NN","NN","JJ","JJ","JJ","NN","NN","JJ","JJ","JJ","JJ","JJ","NN","JJ","NN"]
    i=0
    for sx in s2:
...
#            if tmp != 'NNP':
    ...
    print(s2)
    for sx in s2:
        if last in ('None', 'JJ', 'JJR', 'JJS', 'CD', 'RB', 'RBR', 'RBS', ':', 'NNP', 'VB', 'VBG','VBN','DT','POS','PDT','IN','CC'):
            if not out:
                cx = 1
                out = sx[0]
            else:
